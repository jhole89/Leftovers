...
import com.jhole89.leftovers.ingredient.SearchIngredientActivity
import com.jhole89.leftovers.recipe.SearchRecipeActivity
...
open class BaseActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_ingredients -> launchSearchIngredientActivity()

            R.id.nav_recipes -> launchSearchRecipeActivity()
